...
public class ReceiptDetailView extends BorderPane {
	...
	private Label titleLbl, receiptIdLbl, receiptIdContentLbl, orderIdLbl, orderIdContentLbl, nameLbl, nameContentLbl, paymentAmountLbl, paymentAmountContentLbl, paymentTypeLbl, paymentTypeContentLbl, paymentDateLbl, paymentDateContentLbl, totalPriceLbl, totalPriceContentLbl;
	...
	public ReceiptDetailView(Receipt receipt) {
		...
		titleLbl = new Label("Receipt Detail");
		...
		headerPane.add(paymentDateLbl, 0, 3);
		headerPane.add(paymentDateContentLbl, 1, 3);
